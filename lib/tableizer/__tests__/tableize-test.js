...
describe('tableize()', () => {
  ...
  it('can handle value_unit type', () => {
    const data = [
      { age: { value: '36', unit: 'months' } },
      { age: 10 },
    ];

    const rules = [
      { key: 'age', type: 'value_unit', unit: 'years' },
    ];
  ...
  it('can handle raw value with value_unit type', () => {
    const data = [
      { age: { value: '36', unit: 'months' } },
      { age: 10 },
    ];
    ...
    const rules = [
      { key: 'age', type: 'value_unit', unit: 'years', raw: true },
    ];
